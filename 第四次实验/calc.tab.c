...
static const char *const yytname[] =
{
  ...
  "TIMES", "DIVIDE", "LPAREN", "RPAREN", "$accept", "program", "expr", YY_NULLPTR
};
...
yyreduce:
  ...
  case 2: /* program: expr  */
#line 18 "calc.y"
                       { printf("[bison] result = %d\n", yyvsp[0]); }
#line 1070 "calc.tab.c"
    break;

  case 3: /* expr: NUM  */
#line 22 "calc.y"
                       { yyval = yyvsp[0]; printf("[bison] reduce NUM -> %d\n", yyvsp[0]); }
#line 1076 "calc.tab.c"
    break;

  case 4: /* expr: expr PLUS expr  */
#line 23 "calc.y"
                       { yyval = yyvsp[-2] + yyvsp[0]; printf("[bison] reduce %d + %d = %d\n", yyvsp[-2], yyvsp[0], yyval); }
...
#line 26 "calc.y"
                       { if (yyvsp[0]==0){yyerror("divide by zero");yyval=0;} else {yyval=yyvsp[-2]/yyvsp[0]; printf("[bison] reduce %d / %d = %d\n",yyvsp[-2],yyvsp[0],yyval);} }
#line 1100 "calc.tab.c"
    break;

  case 8: /* expr: LPAREN expr RPAREN  */
#line 27 "calc.y"
                       { yyval = yyvsp[-1]; printf("[bison] reduce (expr) = %d\n", yyval); }
